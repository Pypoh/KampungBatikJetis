...
import com.example.kampungbatikjetis.Adapter.LayananAdapter;
...
public class LayananFragment extends Fragment {
    ...
    private List<LayananModel> layananData = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewLayanan = view.findViewById(R.id.recycler_layanan);
        indicator = view.findViewById(R.id.layanan_indicator);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerViewLayanan.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.HORIZONTAL, false));
        layananAdapter = new LayananAdapter(getContext(), layananData);
        recyclerViewLayanan.setAdapter(layananAdapter);
        PagerSnapHelper pagerSnapHelper = new PagerSnapHelper();
        pagerSnapHelper.attachToRecyclerView(recyclerViewLayanan);
        indicator.attachToRecyclerView(recyclerViewLayanan, pagerSnapHelper);
